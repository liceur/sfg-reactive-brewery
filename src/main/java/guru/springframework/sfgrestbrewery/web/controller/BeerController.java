...
public class BeerController {
    ...
    @ExceptionHandler
    ResponseEntity<Void> handlerNotFound(NotFoundException ex){
    ...
    public ResponseEntity<Mono<Void>> updateBeerById(@PathVariable("beerId") Integer beerId, @RequestBody @Validated BeerDto beerDto){
